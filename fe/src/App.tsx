  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-0 right-0 p-6 z-50">
        <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full text-sm font-semibold transition duration-300 flex items-center">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50">
          <div className="container mx-auto px-4 h-full flex items-center">
            <div className="text-white max-w-2xl">
              ...
              <p className="text-xl mb-8">Experience ancient wonders, vibrant cities, and timeless traditions</p>
      ...
      <div className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Popular China Tours</h2>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Why Choose Our China Tours</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Native guides with deep cultural knowledge</p>
            </div>
            <div className="text-center">
              <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Intimate tours with personalized attention</p>
            </div>
            <div className="text-center">
              <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Immersive cultural activities and local interactions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-red-600 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Begin Your Chinese Adventure</h2>
            <p className="text-xl">Contact us to plan your perfect journey through China</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <form onSubmit={handleSubmit} className="bg-white rounded-lg p-8 shadow-lg">
              ...
              <button type="submit" className="w-full bg-red-600 text-white py-3 rounded-lg hover:bg-red-700 transition duration-300 flex items-center justify-center">
          ...
          <div className="flex justify-center space-x-8 mt-12">
            <a href="tel:+1234567890" className="flex items-center hover:text-red-200 transition duration-300">
              <Phone className="w-6 h-6 mr-2"/>
              +1 234 567 890
            </a>
            <a href="mailto:info@chinatours.com" className="flex items-center hover:text-red-200 transition duration-300">
